...
<body>
    ...
    <div class="container" style="margin-top: 30px;">
        <h4>Uredi informacije o događaju</h4>
      ...
      ?>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title_edit" placeholder="Unesi naziv događaja" name="title"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="image_edit" placeholder="Unesi url fotografije" name="image"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cprice_edit" placeholder="Unesi cijenu ulaznice za djecu"
                    name="cprice" value="<?php echo $row['TicketPriceChild'] ?>">
            </div>
            <div class="form-group">
